...
const { fetchTeachers, deleteTeacher } = teachersStore;
...
const { data: users, refresh } = await useAsyncData('users-teashers', async () => {
      ...
      <div class="flex flex-wrap gap-2 border p-3 rounded-lg mb-2">
         <div class="flex grow">
            <div class="flex flex-wrap gap-3">
               ...
               <ModalUsersUpdatePassword :role="'teacher'" :user-id="activeRow?._id" @show-modal="showModal">
